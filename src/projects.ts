...
import angryfaiceater from './assets/angryfaicgeater.png';
...
if (randomChoice1 <= 0.08)
{
    text1 = `<img src="${angryfaiceater}" id="angryfaic" alt="angry faic??...">`;
    console.debug("IS THAT GOD EATER?!!?!??!?!?!?!?!??!?!?!?!?!?!");
}
else
{
