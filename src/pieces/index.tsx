  ...
  <>
    <div>
      ...
      <div id="team">
        ...
        <div className="small-spacing"></div>
        <div id="members">
          <MemberCard pfpUrl={_julibrosPfp} id='julibros' yt='@Julibros' name='Julibros' roles='sprites, music and some animations' descUrl=''/>
        ...
        <div id="special-thanks">
          ...
          <div id="special-thanks-persons">
            ...
            <SpecialThanksCard name='isa' l1='' l2='' l3='' l4='' l5='' id='isas-frame'/>
            </div>
          </div>
        </div>
      </div>
